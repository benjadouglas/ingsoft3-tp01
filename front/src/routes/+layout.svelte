	...
	<div class="flex min-h-dvh flex-col">
		<header class="border-b">
			<div class="mx-auto flex h-12 max-w-3xl items-center gap-6 px-4">
				<a href="/" class="font-mono text-sm font-semibold tracking-tight">htmlplan</a>
				<div class="ml-auto flex items-center gap-3">
					<span class="hidden text-xs text-muted-foreground sm:inline">{data.usuario.email}</span>
