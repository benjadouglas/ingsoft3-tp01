    ...
    {:else}
        <div class="mt-8 flex flex-col gap-8">
            {#each porProyecto as [proyecto, planes] (proyecto)}
                <section>
                    <h2 class="mb-2 font-mono text-xs text-muted-foreground">
                        {proyecto}
                    </h2>
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    <Badge variant="outline"
                                        >v{plan.version}</Badge
                                    >
                                    <time
                                        datetime={plan.actualizadoEl}
                                        class="w-24 shrink-0 text-right text-xs text-muted-foreground"
                                    >
